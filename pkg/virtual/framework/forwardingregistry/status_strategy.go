...
// NewStatusStrategy creates a strategy for the status sub-resource
...
func (a statusStrategy) GetResetFields() map[fieldpath.APIVersion]*fieldpath.Set {
	fields := map[fieldpath.APIVersion]*fieldpath.Set{
		fieldpath.APIVersion(a.strategy.kind.GroupVersion().String()): fieldpath.NewSet(
...
func (a statusStrategy) ValidateUpdate(ctx context.Context, obj, old runtime.Object) field.ErrorList {
	...
	errs = append(errs, a.strategy.validator.ValidateStatusUpdate(ctx, obj, old, nil)...)
	return errs
}
