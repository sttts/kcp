...
func newStorage(t *testing.T, clientGetter forwardingregistry.ClientGetter, patchConflictRetryBackoff *wait.Backoff) (*forwardingregistry.ForwardingREST, *forwardingregistry.StatusREST) {
	...
	return forwardingregistry.NewForwardingREST(
		gvr,
		kind,
		listKind,
