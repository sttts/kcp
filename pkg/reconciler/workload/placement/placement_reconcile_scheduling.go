...
func (r *placementSchedulingReconciler) reconcile(ctx context.Context, placement *schedulingv1alpha1.Placement) (reconcileStatus, *schedulingv1alpha1.Placement, error) {
	...
	syncTargets, err := r.getAllValidSyncTargetsForPlacement(placement)
	if err != nil {
...
func (r *placementSchedulingReconciler) getAllValidSyncTargetsForPlacement(placement *schedulingv1alpha1.Placement) ([]*workloadv1alpha1.SyncTarget, error) {
