...
func NewController(
	...
	c := &controller{
		...
		createCRD: func(ctx context.Context, crd *apiextensionsv1.CustomResourceDefinition) (*apiextensionsv1.CustomResourceDefinition, error) {
			return crdClusterClient.ApiextensionsV1().CustomResourceDefinitions().Create(logicalcluster.WithCluster(ctx, logicalcluster.From(crd)), crd, metav1.CreateOptions{})
		},
