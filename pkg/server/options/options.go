...
func (o *CompletedOptions) Validate() []error {
	...
	if o.Extra.ShardName != tenancyv1alpha1.RootShard && len(o.Extra.LogicalClusterAdminKubeconfig) == 0 {
		errs = append(errs, fmt.Errorf("--logical-cluster-admin-kubeconfig is required on a non-root shard"))
	}
