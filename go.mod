...
require (
	...
	github.com/kcp-dev/apimachinery v0.0.0-20221208125244-bea0cfae1abb
	github.com/kcp-dev/client-go v0.0.0-20221208151827-40ecb71c3d29
	github.com/kcp-dev/kcp/pkg/apis v0.0.0-00010101000000-000000000000
	github.com/kcp-dev/logicalcluster/v2 v2.0.0-alpha.1
	github.com/kcp-dev/logicalcluster/v3 v3.0.0-20221208123509-ae24e20f8063
